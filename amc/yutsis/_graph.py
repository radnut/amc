...
class YutsisGraph:
    ...
    def remove_redundant_threejs(self):
        """Remove 3j-Symbols that are already part of a 6j-Symbol"""

        for sixj in self.sixjs:
            for tridelta in self.threejs:
                if sixj.contains_threej(tridelta):
                    self.threejs.remove(tridelta)
